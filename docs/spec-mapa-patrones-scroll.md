...
**Input**: Lean Canvas: _"VibeCheck - La app de bienestar digital para adolescentes"_ ([docs/lean-canvas.md](https://github.com/FPoncela/viberano-2026-team9/blob/main/docs/lean-canvas.md)), Solución #1: "Mapa de patrones de scroll — analítica visual de qué apps/contenido enganchan, a qué hora del día, y cuánto tiempo real se dedica a cada tipo de contenido."
